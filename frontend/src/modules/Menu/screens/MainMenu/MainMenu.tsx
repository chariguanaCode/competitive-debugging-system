...
import { MainMenuProps } from './MainMenu.d';
...
const MainMenu: React.FunctionComponent<MainMenuProps> = memo(
    ({ open, handleClose, isAnyProjectOpen, deafultSelectedSector }) => {
                ...
                <div className={classes.MainMenu}>
                    {open && (
                        <Menu
                            ...
                            contents={Contents}
                            defaultSelectedSector={deafultSelectedSector}
                            buttons={Buttons.map((button) => ({
                                ...
                                disabled:
                                    ...
                                    (button.doesNeedSaveLocation && (!!!projectFile || !!!projectFile.hasSaveLocation)),
                            }))}
                        />
                    )}
                </div>
