...
const OptionsInfo: React.FunctionComponent<OptionsInfoTypes> = ({optionName, selectOption}) => {
    switch(optionName){
        case "Create Project":
            return <>
                <MenuList>
                    <MenuItem onClick = {()=>{selectOption("onecpp")}}> New project from one .cpp file </MenuItem>
                    <MenuItem onClick = {()=>{selectOption("empty")}}> New empty project </MenuItem>
                    <MenuItem onClick = {()=>{selectOption("manycpp")}}> New project from many .cpp files </MenuItem>
                </MenuList>
            </>
        case "Save As":
            return <>
            ...
            <div className = {classes.mainMenu} >
                <MenuList className = {classes.mainMenuOptionsList}>
                    ...
                    return <MenuItem 
                                ...
                                onClick = { () => {setOptionInfo(obj.name)} } 
                                className = {classes.menuItem} 
                                style = {{backgroundColor: obj.name === optionInfo ? theme.palette.mainMenu.selectedButtonBackgroundColor : "transparent" }}
                            >
                                {React.cloneElement(obj.icon, {style: {color: theme.palette.mainMenu.iconColorEnabled}})}
